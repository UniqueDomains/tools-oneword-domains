...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C908%20rows-8250df">
...
> **Important:** this repository is a **public 7,908-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,079 domains** on the canonical page below.

**Public extract:** 7,908 rows · **Live catalog:** 5,622,079 domains
...
- `tools.csv` — public CSV extract (7,908 rows)
- `tools.json` — public JSON extract (7,908 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,908-row public sample | 5,622,079 live domains                           |
...
> Unique Domains. *Available .TOOLS One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
