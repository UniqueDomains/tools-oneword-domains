...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C911%20rows-8250df">
...
**Public extract:** 7,911 rows · **Live catalog:** 7,908 domains
...
- `tools.csv` — public CSV extract (7,911 rows)
- `tools.json` — public JSON extract (7,911 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,911-row public sample | 7,908 live domains                               |
